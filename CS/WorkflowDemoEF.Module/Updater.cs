...
namespace WorkflowDemoEF.Module {
    public class Updater : ModuleUpdater {
        ...
        private void CreateDemoObjects() {
            ...
            if(ObjectSpace.GetObjects<EFWorkflowDefinition>().Count == 0) {
                EFWorkflowDefinition definition = ObjectSpace.CreateObject<EFWorkflowDefinition>();
                ...
                EFWorkflowDefinition codeActivityDefinition = ObjectSpace.CreateObject<EFWorkflowDefinition>();
                ...
                EFWorkflowDefinition customStartWorkflowActivityDefinition = ObjectSpace.CreateObject<EFWorkflowDefinition>();
                ...
                customStartWorkflowActivityDefinition.TargetObjectType = typeof(WorkflowDemoEF.Module.Objects.Task);
                customStartWorkflowActivityDefinition.IsActive = true;

                EFWorkflowDefinition receiveCorrelationsActivityDefinition = ObjectSpace.CreateObject<EFWorkflowDefinition>();
                ...
                receiveCorrelationsActivityDefinition.TargetObjectType = typeof(WorkflowDemoEF.Module.Objects.Task);
    ...
    @" xmlns:dpb=""clr-namespace:DevExpress.Persistent.BaseImpl.EF;assembly=DevExpress.Persistent.BaseImpl.EF.v" + AssemblyInfo.VersionShort + @"""" +
    ...
    @" xmlns:mc=""http://schemas.openxmlformats.org/markup-compatibility/2006"" xmlns:mva=""clr-namespace:Microsoft.VisualBasic.Activities;assembly=System.Activities"" xmlns:s=""clr-namespace:System;assembly=mscorlib"" xmlns:s1=""clr-namespace:System;assembly=System"" xmlns:s2=""clr-namespace:System;assembly=System.Core"" xmlns:s3=""clr-namespace:System;assembly=System.ServiceModel"" xmlns:s4=""clr-namespace:System;assembly=System.Drawing.Design"" xmlns:s5=""clr-namespace:System;assembly=System.Configuration.Install"" xmlns:s6=""clr-namespace:System;assembly=System.DirectoryServices.Protocols"" xmlns:sa=""clr-namespace:System.Activities;assembly=System.Activities"" xmlns:sap=""http://schemas.microsoft.com/netfx/2009/xaml/activities/presentation"" xmlns:wc=""clr-namespace:WorkflowDemoEF.Module.Objects;assembly=WorkflowDemoEF.Module"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"">
  <x:Members>
  ...
  <dwa:ObjectSpaceTransactionScope AutoCommit=""True"" sap:VirtualizedContainerService.HintSize=""267.2,372.8"" mva:VisualBasic.Settings=""Assembly references and imported namespaces serialized as XML namespaces"">
    ...
    <Delay Duration=""00:00:01"" sap:VirtualizedContainerService.HintSize=""242,22"" />
        ...
        private const string CodeActivityCreateTaskForActiveIssueWorkflowXaml =
            @"<Activity mc:Ignorable=""sap"" x:Class=""DevExpress.Workflow.xWF1"" xmlns=""http://schemas.microsoft.com/netfx/2009/xaml/activities"" xmlns:mc=""http://schemas.openxmlformats.org/markup-compatibility/2006"" xmlns:mva=""clr-namespace:Microsoft.VisualBasic.Activities;assembly=System.Activities"" xmlns:s=""clr-namespace:System;assembly=mscorlib"" xmlns:s1=""clr-namespace:System;assembly=System"" xmlns:s2=""clr-namespace:System;assembly=System.Core"" xmlns:s3=""clr-namespace:System;assembly=System.ServiceModel"" xmlns:sa=""clr-namespace:System.Activities;assembly=System.Activities"" xmlns:sap=""http://schemas.microsoft.com/netfx/2009/xaml/activities/presentation"" xmlns:scg=""clr-namespace:System.Collections.Generic;assembly=mscorlib"" xmlns:wm=""clr-namespace:WorkflowDemoEF.Module.Activities;assembly=WorkflowDemoEF.Module"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"">
  <x:Members>
    <x:Property Name=""targetObjectId"" Type=""InArgument(x:Object)"" />
  </x:Members>
...
@"<Activity mc:Ignorable=""sap"" x:Class=""DevExpress.Workflow.xWF1"" sap:VirtualizedContainerService.HintSize=""812,627"" mva:VisualBasic.Settings=""Assembly references and imported namespaces serialized as XML namespaces"" xmlns=""http://schemas.microsoft.com/netfx/2009/xaml/activities"" " +
    @" xmlns:dpb=""clr-namespace:DevExpress.Persistent.BaseImpl.EF;assembly=DevExpress.Persistent.BaseImpl.EF.v" + AssemblyInfo.VersionShort + @"""" +
    @" xmlns:dwa=""clr-namespace:DevExpress.Workflow.Activities;assembly=DevExpress.Workflow.Activities.v" + AssemblyInfo.VersionShort + @"""" +
    @" xmlns:mc=""http://schemas.openxmlformats.org/markup-compatibility/2006"" xmlns:mva=""clr-namespace:Microsoft.VisualBasic.Activities;assembly=System.Activities"" xmlns:p=""http://schemas.microsoft.com/netfx/2009/xaml/servicemodel"" xmlns:s=""clr-namespace:System;assembly=mscorlib"" xmlns:s1=""clr-namespace:System;assembly=System"" xmlns:s2=""clr-namespace:System;assembly=System.Core"" xmlns:s3=""clr-namespace:System;assembly=System.ServiceModel"" xmlns:sa=""clr-namespace:System.Activities;assembly=System.Activities"" xmlns:sap=""http://schemas.microsoft.com/netfx/2009/xaml/activities/presentation"" xmlns:scg=""clr-namespace:System.Collections.Generic;assembly=mscorlib"" xmlns:wmo=""clr-namespace:WorkflowDemoEF.Module.Objects;assembly=WorkflowDemoEF.Module"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"">
  ...
  <Sequence DisplayName=""Main"" sap:VirtualizedContainerService.HintSize=""290,1158"">
    <Sequence.Variables>
      ...
      <Variable x:TypeArguments=""s:Int32"" Name=""taskId"" />
    </Sequence.Variables>
    <sap:WorkflowViewStateService.ViewState>
    ...
    <dwa:ObjectSpaceTransactionScope AutoCommit=""True"" sap:VirtualizedContainerService.HintSize=""268,333"">
      ...
      <Assign sap:VirtualizedContainerService.HintSize=""242,58"">
        <Assign.To>
          <OutArgument x:TypeArguments=""s:Int32"">[taskId]</OutArgument>
        </Assign.To>
        <Assign.Value>
          <InArgument x:TypeArguments=""s:Int32"">[task.Id]</InArgument>
        </Assign.Value>
      </Assign>
    </dwa:ObjectSpaceTransactionScope>
