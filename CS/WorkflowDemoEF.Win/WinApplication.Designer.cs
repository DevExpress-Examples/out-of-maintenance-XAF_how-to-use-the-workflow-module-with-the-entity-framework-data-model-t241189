...
{
	partial class WorkflowDemoEFWindowsFormsApplication
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
			...
			this.module4 = new WorkflowDemoEF.Module.Win.WorkflowDemoEFWindowsFormsModule();
            ...
            this.wfModule.RunningWorkflowInstanceInfoType = typeof(EFRunningWorkflowInstanceInfo);
            this.wfModule.StartWorkflowRequestType = typeof(EFStartWorkflowRequest);
            this.wfModule.UserActivityVersionType = typeof(DevExpress.ExpressApp.Workflow.Versioning.EFUserActivityVersion);
            this.wfModule.WorkflowControlCommandRequestType = typeof(EFWorkflowInstanceControlCommandRequest);
            this.wfModule.WorkflowDefinitionType = typeof(EFWorkflowDefinition);
            this.wfModule.WorkflowInstanceKeyType = typeof(EFInstanceKey);
            this.wfModule.WorkflowInstanceType = typeof(EFWorkflowInstance);            
            this.wfModule.UserActivityVersionType = typeof(DevExpress.ExpressApp.Workflow.Versioning.EFUserActivityVersion);
            // 
		...
		private WorkflowDemoEF.Module.Win.WorkflowDemoEFWindowsFormsModule module4;
